...
export async function planCommand(feature, options) {
    ...
    try {
        ...
        console.log(infoBox(`${result.repos.length} repos | ${taskCount} tasks | ${result.crossCuttingConcerns.length} concerns`, "Plan Saved"));
        // Generate README
...
function generateReadme(plan, projectName) {
